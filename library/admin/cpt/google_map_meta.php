<?php
/**
 * Kystmagasinet Theme Customizer
 *
 * @package Kystmagasinet
 *
 **
...
class PW_CMB2_Field_Google_Maps {
	...
	public function setup_admin_scripts($api_key) {
		wp_register_script( 'pw-google-maps-api', "https://maps.googleapis.com/maps/api/js?key={AIzaSyBr2q08BHCBK-HWA3y0InCwKsCcxPwHDcU}&libraries=places", null, null );
		wp_enqueue_script( 'pw-google-maps', get_template_directory_uri() . '/library/admin/assets/js/scripts.js', array( 'pw-google-maps-api', 'jquery' ), self::VERSION );
		wp_enqueue_style( 'pw-google-maps', get_template_directory_uri() . '/library/admin/assets/css/style.css', array(), self::VERSION );
	}
